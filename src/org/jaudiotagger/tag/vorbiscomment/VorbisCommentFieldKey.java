...
public enum VorbisCommentFieldKey
{
    ...
    WORK_PART_LEVEL2_TYPE("WORK_PART_LEVEL2_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL3("WORK_PART_LEVEL3",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL3_TYPE("WORK_PART_LEVEL3_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL4("WORK_PART_LEVEL4",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL4_TYPE("WORK_PART_LEVEL4_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL5("WORK_PART_LEVEL5",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL5_TYPE("WORK_PART_LEVEL5_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL6("WORK_PART_LEVEL6",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL6_TYPE("WORK_PART_LEVEL6_TYPE",EnumSet.of(Tagger.JAIKOZ)),
