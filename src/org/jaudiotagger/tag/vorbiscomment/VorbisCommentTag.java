...
public class VorbisCommentTag extends AbstractTag
{
    ...
    static
    {
        ...
        tagFieldToOggField.put(FieldKey.PERFORMANCE_YEAR, VorbisCommentFieldKey.PERFORMANCE_YEAR);
        ...
        tagFieldToOggField.put(FieldKey.REPLAYGAIN_TRACK_PEAK, VorbisCommentFieldKey.REPLAYGAIN_TRACK_PEAK);
