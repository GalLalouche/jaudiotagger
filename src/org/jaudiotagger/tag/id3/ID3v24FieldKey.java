...
public enum ID3v24FieldKey
{
    ...
    ACOUSTIC(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.ACOUSTIC, Id3FieldType.TEXT),
    ...
    ELECTRONIC(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.ELECTRONIC, Id3FieldType.TEXT),
    ...
    INSTRUMENTAL(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.INSTRUMENTAL, Id3FieldType.TEXT),
    ...
    REPLAYGAIN_TRACK_GAIN(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.REPLAYGAIN_TRACK_GAIN, Id3FieldType.TEXT),
    REPLAYGAIN_TRACK_PEAK(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.REPLAYGAIN_TRACK_PEAK, Id3FieldType.TEXT),
    ...
    WORK_COMPOSITION(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_COMPOSITION, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL3_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL3_TYPE, Id3FieldType.TEXT),
    WORK_PART_LEVEL1(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL1, Id3FieldType.TEXT),
    WORK_PART_LEVEL1_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL1_TYPE, Id3FieldType.TEXT),
    WORK_PART_LEVEL2(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL2, Id3FieldType.TEXT),
    WORK_PART_LEVEL2_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL2_TYPE, Id3FieldType.TEXT),
    WORK_PART_LEVEL3(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL3, Id3FieldType.TEXT),
    WORK_PART_LEVEL4(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL4, Id3FieldType.TEXT),
    WORK_PART_LEVEL4_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL4_TYPE, Id3FieldType.TEXT),
    WORK_PART_LEVEL5(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL5, Id3FieldType.TEXT),
    WORK_PART_LEVEL5_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL5_TYPE, Id3FieldType.TEXT),
    WORK_PART_LEVEL6(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL6, Id3FieldType.TEXT),
    WORK_PART_LEVEL6_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PART_LEVEL6_TYPE, Id3FieldType.TEXT),
