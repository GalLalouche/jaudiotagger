...
public enum ID3v22FieldKey
{
    ...
    ALBUM_YEAR(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.ALBUM_YEAR, Id3FieldType.TEXT),
    AMAZON_ID(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.AMAZON_ASIN, Id3FieldType.TEXT),
    ARRANGER(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.ARRANGER, Id3FieldType.TEXT),
    ARRANGER_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.ARRANGER_SORT, Id3FieldType.TEXT),
    ARRANGER_INVOLVEDPEOPLE(ID3v22Frames.FRAME_ID_V2_IPLS,  StandardIPLSKey.ARRANGER.getKey(), Id3FieldType.TEXT),
    ...
    AUDIO_ENGINEER(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.AUDIO_ENGINEER, Id3FieldType.TEXT),
    AUDIO_ENGINEER_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.AUDIO_ENGINEER_SORT, Id3FieldType.TEXT),
    BALANCE_ENGINEER(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.BALANCE_ENGINEER, Id3FieldType.TEXT),
    BALANCE_ENGINEER_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.BALANCE_ENGINEER_SORT, Id3FieldType.TEXT),
    ...
    CREDITS(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.CREDITS, Id3FieldType.TEXT),
    ...
    DJMIXER(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.DJMIXER, Id3FieldType.TEXT),
    DJMIXER_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.DJMIXER_SORT, Id3FieldType.TEXT),
    DJMIXER_INVOLVEDPEOPLE(ID3v22Frames.FRAME_ID_V2_IPLS,  StandardIPLSKey.DJMIXER.getKey(), Id3FieldType.TEXT),
    ENCODER(ID3v22Frames.FRAME_ID_V2_ENCODEDBY, Id3FieldType.TEXT),
    ENGINEER(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.ENGINEER, Id3FieldType.TEXT),
    ENGINEER_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.ENGINEER_SORT, Id3FieldType.TEXT),
    ENGINEER_INVOLVEDPEOPLE(ID3v22Frames.FRAME_ID_V2_IPLS, StandardIPLSKey.ENGINEER.getKey(), Id3FieldType.TEXT),
    ...
    INVOLVEDPEOPLE(ID3v22Frames.FRAME_ID_V2_IPLS, Id3FieldType.TEXT),
    INSTRUMENT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.INSTRUMENT, Id3FieldType.TEXT),
    IPI(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.IPI, Id3FieldType.TEXT),
    ISRC(ID3v22Frames.FRAME_ID_V2_ISRC, Id3FieldType.TEXT),
    ISWC(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.ISWC, Id3FieldType.TEXT),
    ...
    IS_GREATEST_HITS(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.IS_GREATEST_HITS, Id3FieldType.TEXT),
    IS_HD(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.IS_HD, Id3FieldType.TEXT),
    IS_LIVE(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.LIVE, Id3FieldType.TEXT),
    ...
    JAIKOZ_ID(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.JAIKOZ_ID, Id3FieldType.TEXT),
    ...
    LYRICIST_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.LYRICIST_SORT, Id3FieldType.TEXT),
    LYRICS(ID3v22Frames.FRAME_ID_V2_UNSYNC_LYRICS, Id3FieldType.TEXT),
    MASTERING(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.MASTERING, Id3FieldType.TEXT),
    MASTERING_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.MASTERING_SORT, Id3FieldType.TEXT),
    MEDIA(ID3v22Frames.FRAME_ID_V2_MEDIA_TYPE, Id3FieldType.TEXT),
    MIXER(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.MIXER, Id3FieldType.TEXT),
    MIXER_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.MIXER_SORT, Id3FieldType.TEXT),
    MIXER_INVOLVEDPEOPLE(ID3v22Frames.FRAME_ID_V2_IPLS,  StandardIPLSKey.MIXER.getKey(), Id3FieldType.TEXT),
    ...
    MUSICBRAINZ_RECORDING_WORK(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_RECORDING_WORK, Id3FieldType.TEXT),
    MUSICBRAINZ_RECORDING_WORK_ID(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_RECORDING_WORK_ID, Id3FieldType.TEXT),
    ...
    ORIGINALRELEASEDATE(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.ORIGINALRELEASEDATE, Id3FieldType.TEXT),
    ...
    OVERALL_WORK(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.OVERALL_WORK, Id3FieldType.TEXT),
    ...
    PERFORMANCE_YEAR(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.PERFORMANCE_YEAR, Id3FieldType.TEXT),
    ...
    PRODUCER(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.PRODUCER, Id3FieldType.TEXT),
    PRODUCER_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.PRODUCER_SORT, Id3FieldType.TEXT),
    PRODUCER_INVOLVEDPEOPLE(ID3v22Frames.FRAME_ID_V2_IPLS,  StandardIPLSKey.PRODUCER.getKey(), Id3FieldType.TEXT),
    ...
    RECORDINGDATE(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.RECORDINGDATE, Id3FieldType.TEXT),
    RECORDINGENDDATE(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.RECORDINGENDDATE, Id3FieldType.TEXT),
    RECORDINGLOCATION(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.RECORDINGLOCATION, Id3FieldType.TEXT),
    RECORDINGSTARTDATE(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.RECORDINGSTARTDATE, Id3FieldType.TEXT),
    RECORDING_ENGINEER(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.RECORDING_ENGINEER, Id3FieldType.TEXT),
    RECORDING_ENGINEER_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.RECORDING_ENGINEER_SORT, Id3FieldType.TEXT),
    ...
    REPLAYGAIN_TRACK_GAIN(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.REPLAYGAIN_TRACK_GAIN, Id3FieldType.TEXT),
    REPLAYGAIN_TRACK_PEAK(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.REPLAYGAIN_TRACK_PEAK, Id3FieldType.TEXT),
    ROONALBUMTAG(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.ROONALBUMTAG, Id3FieldType.TEXT),
    ROONTRACKTAG(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.ROONTRACKTAG, Id3FieldType.TEXT),
    SCRIPT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.SCRIPT, Id3FieldType.TEXT),
    SECTION(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.SECTION, Id3FieldType.TEXT),
    SINGLE_DISC_TRACK_NO(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.SINGLE_DISC_TRACK_NO, Id3FieldType.TEXT),
    SONGKONG_ID(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.SONGKONG_ID, Id3FieldType.TEXT),
    SOUND_ENGINEER(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.SOUND_ENGINEER, Id3FieldType.TEXT),
    SOUND_ENGINEER_SORT(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.SOUND_ENGINEER_SORT, Id3FieldType.TEXT),
    ...
    URL_BANDCAMP_ARTIST_SITE(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_URL, FrameBodyWXXX.URL_BANDCAMP_ARTIST_SITE, Id3FieldType.TEXT),
    URL_BANDCAMP_RELEASE_SITE(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_URL, FrameBodyWXXX.URL_BANDCAMP_RELEASE_SITE, Id3FieldType.TEXT),
    ...
    VERSION(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO, FrameBodyTXXX.VERSION, Id3FieldType.TEXT),
