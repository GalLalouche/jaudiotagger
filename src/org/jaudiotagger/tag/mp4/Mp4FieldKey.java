...
public enum Mp4FieldKey
{
    ...
    CHOIR_SORT("com.apple.iTunes","Choir Sort",  TEXT, Tagger.JAIKOZ),
    ...
    PERFORMER_NAME("com.apple.iTunes","Performer Name",  TEXT, Tagger.JAIKOZ),
    PERFORMER_NAME_SORT("com.apple.iTunes","Performer Name Sort",  TEXT, Tagger.JAIKOZ),
    ...
    WORK_COMPOSITION("com.apple.iTunes","Work Composition",  TEXT, Tagger.JAIKOZ),
